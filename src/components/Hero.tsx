          ...
          {freeTrialBanner && (
            <div className="max-w-xl mx-auto pt-2 relative z-10">
              <a
                ...
                className="inline-flex flex-wrap items-center justify-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.02] hover:bg-white/[0.05] border border-card-border hover:border-text-sec/30 transition-all text-xs text-text-sec hover:text-text-main group"
              >
                ...
                <span className="inline-flex items-center gap-1 font-semibold text-text-main group-hover:underline">

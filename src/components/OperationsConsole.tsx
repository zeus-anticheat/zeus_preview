      ...
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row gap-14 items-center">
          <div className="flex-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent/10 border border-accent/20 text-accent text-xs font-semibold uppercase tracking-wider rounded-full mb-6">
            ...
            <div className="bg-[#0b0e17] border border-card-border/80 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-md">
              ...
              <div className="p-6 grid grid-cols-1 gap-4">
                {content.panels.map((panel) => (
                  <article className="bg-[#07090e] border border-card-border/60 p-5 rounded-xl hover:border-accent/30 transition-colors shadow-sm" key={panel.id}>
